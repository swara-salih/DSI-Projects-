...
- Perform methods of exploratory data analysis, including:
  - Use Matplotlib & Tableau (bonus) to create visualizations
...
- Conclusion - next steps, further questions, what you would do with more time, additional data that would be useful.
